...
int main()
{
  ...
  if (!(win1 = mlx_new_window(mlx, WIN1_SX, WIN1_SY, "MLX-Title1")))
  {
    printf(" !! KO !!\n");
    exit(1);
  }
  ...
  printf(" => 2nd window,");
  win2 = mlx_new_window(mlx, WIN1_SX, WIN1_SY, "MLX-Title2");
  ...
  win3 = mlx_new_window(mlx, WIN1_SX, WIN1_SY, "MLX-Title3");
